        ...
        while index < bytes.len() {
            ...
            match command {
                ...
                "citefield" if in_document => {
                    ...
                    if let Some((keys, content_start, content_end, after_key)) =
                        read_braced_source_argument(source, index)
                    {
                        let field_index = skip_ascii_whitespace(source, after_key);
                        if let Some((_, _, _, after_field)) =
                            read_braced_source_argument(source, field_index)
                        {
                            self.emit_render_event(
                                RenderEvent::InlineCitation(InlineCitationEvent {
                                    keys: keys
                            ...
                            while inner_index < content_end {
                                ...
                                match inner_command {
                                    ...
                                    "citefield" => {
                                        ...
                                        if let Some((keys, key_start, key_end, after_key)) =
                                            read_braced_source_argument(source, argument_index)
                                            && after_key <= content_end
                                        {
                                            let field_index =
                                                skip_ascii_whitespace(source, after_key);
                                    ...
                                    "href" => {
                                        ...
                                        if let Some((
                                            ...
                                            && after_target <= content_end
                                        {
                                            let text_index =
                                                skip_ascii_whitespace(source, after_target);
                                    ...
                                    "nolinkurl" | "path" | "detokenize" => {
                                        let argument_index =
                                            skip_ascii_whitespace(source, inner_index);
                                        let argument = if inner_command == "detokenize" {
                                            read_braced_source_argument(source, argument_index)
                                        } else {
                                            read_url_like_source_argument(source, argument_index)
                                        };
                                                ...
                                                while argument_inner_index < text_end {
                                                    ...
                                                    match argument_command {
                                                        ...
                                                        _ => {
                                                            ...
                                                            {
                                                                if text.contains('\\') {
                                                                    let mut nested_index =
                                                                        text_start;
                                                                    let mut nested_text_start =
                                                                        text_start;
                                                                    let mut emitted_structured =
                                                                        false;
                                                                    while nested_index
                                                                        < visible_text_end
                                                                    {
                                                                        if bytes[nested_index]
                                                                            != b'\\'
                                                                        {
                                                                            nested_index += 1;
                                                                            continue;
                                                                        }
                                                                        let nested_command_start =
                                                                            nested_index;
                                                                        nested_index += 1;
                                                                        if nested_index
                                                                            >= visible_text_end
                                                                        ...
                                                                        match nested_command {
                                                                            ...
                                                                            "citefield" => {
                                                                                ...
                                                                                ) && after_key <= visible_text_end
                                                                                {
                                                                                    ...
                                                                                    if let Some((
                                                                                        ...
                                                                                        source,
                                                                                        field_index,
                                                                                    ) && after_citation <= visible_text_end
                                                                                    {
                                                                                        self.capture_text_events(
                                                                                            source_path,
                                                                                            source,
                                                                            ...
                                                                            | "Citetalias" => {
                                                                                ...
                                                                                let mut citation_index =
                                                                                    skip_ascii_whitespace(
                                                                                        source,
                                                                                        nested_index,
                                                                                    );
                                                                                if citation_index < visible_text_end
                                                                                ...
                                                                                loop {
                                                                                    ...
                                                                                    if after_option > visible_text_end
                                                                                    {
                                                                                        break;
                                                                                    }
                                                                                    citation_index = after_option;
                                                                                }
                                                                                if let Some((
                                                                                    keys,
                                                                                    key_start,
...
fn normalize_latex_text_with_inline_placeholders(source: &str) -> String {
    ...
    while scan_index < source.len() {
        ...
        if matches!(command, "phantom" | "hphantom" | "vphantom") {
        ...
        if command == "citefield" {
            ...
            if let Some((_, _, _, after_key)) = read_braced_source_argument(source, argument_index)
            {
                let field_index = skip_ascii_whitespace(source, after_key);
                if let Some((_, _, _, command_after)) =
                    read_braced_source_argument(source, field_index)
...
";
    ...
    #[test]
    fn render_event_capture_records_onecolabstract_without_fallback() {
        let source = r"\begin{document}\begin{onecolabstract}One-column \cite{key} abstract.\end{onecolabstract}\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
    ...
    #[test]
    fn render_event_capture_records_cjk_wrappers_without_font_arguments() {
        let source = r"\documentclass{article}\usepackage{CJKutf8}\usepackage{CJK}\begin{document}\begin{CJK}{UTF8}{gbsn}CJK \cite{key} text.\end{CJK}\begin{CJK*}{UTF8}{bsmi}Star text.\end{CJK*}\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
        ...
        for package in ["CJKutf8.sty", "CJK.sty"] {
            assert!(!outcome.diagnostics.iter().any(|diagnostic| {
                diagnostic.kind == VmDiagnosticKind::MissingFile
                    && diagnostic.detail == format!("package {package}")
            }));
        ...
        assert!(!outcome.render_events.iter().any(|event| {
            match &event.event {
                RenderEvent::Text(text) => ["UTF8", "gbsn", "bsmi"]
                    .iter()
    ...
    #[test]
    fn render_event_capture_records_citefield_without_leaking_keys_or_fields() {
        let source = r"\begin{document}Fields \citefield{alpha}{doi}, \citefield{beta}{year}, and nested \emph{\citefield{gamma}{journal}}.\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
        ...
        assert_eq!(citations[0].command, "citefield");
        assert_eq!(citations[0].keys, vec!["alpha".to_string()]);
        assert_eq!(citations[1].command, "citefield");
        assert_eq!(citations[1].keys, vec!["beta".to_string()]);
        assert_eq!(citations[2].command, "citefield");
        assert_eq!(citations[2].keys, vec!["gamma".to_string()]);
        assert!(
            citations
                .iter()
                .all(|citation| citation.style_hint == CitationStyleHint::Textual)
        );
        assert!(!outcome.render_events.iter().any(|event| matches!(
            &event.event,
            RenderEvent::Text(text)
    ...
    fn render_event_capture_records_url_text_wrappers_without_link_annotations() {
        ...
        assert!(text_events.iter().any(|(text, span)| {
            text.as_str() == "https://example.test/paper"
                && matches!(
                    span,
                    tex_render_model::ProvenanceSpan::File(span)
                        if span.path == Utf8PathBuf::from("main.tex")
    ...
    #[test]
    fn render_event_capture_records_nested_text_wrapper_links() {
        let source = r"\begin{document}Nested \emph{read \href{https://hidden.test}{paper} and \url{https://shown.test}}.\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
        ...
        let visible_text = outcome
            ...
            .collect::<Vec<_>>()
            .join("");
        assert!(visible_text.contains("Nested read "));
        assert!(visible_text.contains(" and "));
        assert!(visible_text.contains("."));
        assert!(!visible_text.contains("https://hidden.test"));
    ...
    #[test]
    fn render_event_capture_records_nested_wrapper_unknown_command_text_wrappers() {
        let source = r"\begin{document}Nested \emph{before \unknowntext{outer \textbf{inner text} done} after}.\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
        ...
        assert!(visible_text.contains("Nested before outer inner text done after."));
        assert!(!visible_text.contains("unknowntext"));
        assert!(!visible_text.contains("textbf"));
        assert!(!visible_text.contains("{inner text}"));
    }
    ...
    #[test]
    fn render_event_capture_records_nested_wrapper_unknown_command_nested_unknown_commands() {
        let source = r"\begin{document}Nested \emph{before \unknowntext{outer \innerunknown{inner text} done} after}.\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
    ...
    #[test]
    fn render_event_capture_records_nested_unknown_url_text_wrappers() {
        let source = r"\begin{document}Nested \emph{before \unknowntext{outer \innerunknown{use \nolinkurl{https://visible.test/path}, \path|/tmp/archive|, and \detokenize{\foo+*}} done} after}.\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
    ...
    #[test]
    fn render_event_capture_records_verse_without_fallback() {
        let source = r"\begin{document}\begin{verse}Line \cite{key} text.\end{verse}\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
        ...
        assert!(!outcome.render_events.iter().any(|event| matches!(
            &event.event,
            RenderEvent::RawFallback(fallback)
                if fallback.environment.as_deref() == Some("verse")
        )));
    }
    ...
    #[test]
    fn render_event_capture_records_sloppypar_without_fallback() {
        let source =
    ...
    #[test]
    fn render_event_capture_records_flush_alignment_without_fallback() {
        let source = r"\begin{document}\begin{flushleft}Left \cite{key} text.\end{flushleft}\begin{flushright}Right text.\end{flushright}\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
        ...
        for environment in ["flushleft", "flushright"] {
            assert!(outcome.render_events.iter().any(|event| {
                matches!(
                    &event.event,
                    RenderEvent::BeginBlock(BeginBlockEvent {
    ...
    #[test]
    fn render_event_capture_records_samepage_without_fallback() {
        let source = r"\begin{document}\begin{samepage}Together \cite{key} text.\end{samepage}\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
        ...
        assert!(!outcome.render_events.iter().any(|event| matches!(
            &event.event,
            RenderEvent::RawFallback(fallback)
                if fallback.environment.as_deref() == Some("samepage")
        )));
    }

    #[test]
    fn render_event_capture_records_titlepage_without_fallback() {
        let source =
        ...
        assert!(!outcome.render_events.iter().any(|event| matches!(
            &event.event,
            RenderEvent::RawFallback(fallback)
                if fallback.environment.as_deref() == Some("titlepage")
        )));
    }

    #[test]
    fn render_event_capture_records_boxed_wrappers_without_style_options() {
        let source = r"\begin{document}\begin{framed}Frame \cite{key} text.\end{framed}\begin{shaded}Shade text.\end{shaded}\begin{tcolorbox}[colback=yellow]Color text.\end{tcolorbox}\begin{mdframed}[linecolor=red]Border text.\end{mdframed}\end{document}";
        let mut interner = ControlSequenceInterner::new();
        let mut vm = Vm::new(&mut interner);
        vm.set_entry_source_path("main.tex");
        vm.enable_render_event_capture();
        ...
        for environment in ["framed", "shaded", "tcolorbox", "mdframed"] {
            assert!(outcome.render_events.iter().any(|event| {
                matches!(
                    &event.event,
                    RenderEvent::BeginBlock(BeginBlockEvent {
        ...
        assert!(!outcome.render_events.iter().any(|event| {
            match &event.event {
                RenderEvent::Text(text) => ["colback", "yellow", "linecolor", "red"]
                    .iter()
                    .any(|argument| text.text.contains(argument)),
                RenderEvent::RawFallback(fallback) => matches!(
                    fallback.environment.as_deref(),
    ...
    fn render_event_capture_records_algorithmic_environment_blocks_without_fallback() {
        ...
        assert_eq!(environment_begins, vec!["algorithmic", "algorithmic*"]);
        assert_eq!(environment_ends, vec!["algorithmic", "algorithmic*"]);
        assert!(outcome.render_events.iter().any(|event| {
            matches!(
                &event.event,
                RenderEvent::Text(text) if text.text == "Step"
