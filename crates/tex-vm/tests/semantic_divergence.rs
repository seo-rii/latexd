...
#[test]
fn runtime_false_nested_nohyper_link_does_not_leak_scanner_text() {
    let outcome = capture(
        r"\count0=0
\begin{document}
\begin{NoHyper}
\ifnum\count0>0\emph{\href{https://wrong.test}{Wrong}}\fi
\emph{\href{https://right.test}{Right}}
\end{NoHyper}
\end{document}",
    );
    let text = outcome
...
#[test]
fn runtime_false_deeply_nested_nohyper_link_does_not_leak_scanner_text() {
    let outcome = capture(
        r"\count0=0
\begin{document}
\begin{NoHyper}
\ifnum\count0>0\emph{\unknownwrapper{\href{https://wrong.test}{Wrong}}}\fi
\emph{\unknownwrapper{\href{https://right.test}{Right}}}
\end{NoHyper}
\end{document}",
    );
    let text = outcome
...
#[test]
fn runtime_false_deeply_nested_nohyper_url_does_not_leak_scanner_text() {
    let outcome = capture(
        r"\count0=0
\begin{document}
\begin{NoHyper}
\ifnum\count0>0\emph{\unknownwrapper{\url{wrong.example}}}\fi
\emph{\unknownwrapper{\url{right.example}}}
\end{NoHyper}
\end{document}",
    );
    let text = outcome
...
\begin{document}
\begin{NoHyper}
\ifnum\count0>0\href{https://wrong.test}{Wrong}\url{wrong.example}\fi
\href{https://right.test}{Right}\url{right.example}
\end{NoHyper}
\end{document}",
    );
    let text = outcome
...
fn runtime_false_color_containers_do_not_leak_scanner_text() {
    let outcome = capture(
        r"\count0=0
\begin{document}
\ifnum\count0>0\textcolor{red}{Wrong}\fcolorbox{red}{white}{Hidden}\fi
\textcolor{blue}{Right}\fcolorbox{blue}{white}{Visible}
\end{document}",
    );
    let text = outcome
        .render_events
    ...
    assert!(
        text.iter()
            .all(|text| *text != "Wrong" && *text != "Hidden"),
        "{:#?}",
        outcome.render_events
    );
...
#[test]
fn runtime_false_float_layout_container_does_not_leak_scanner_text() {
    let outcome = capture(
        r"\count0=0
\begin{document}
\ifnum\count0>0
\begin{figure}\begin{minipage}{0.5\textwidth}Wrong\end{minipage}\end{figure}
\fi
\begin{figure}\begin{minipage}{0.5\textwidth}Right\end{minipage}\end{figure}
\end{document}",
    );
    let text = outcome
        .render_events
