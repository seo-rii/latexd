struct SamePageTrailingInputSiblingOrderingFixture {
...
#[derive(Clone, Copy)]
enum SamePageTrailingInputSiblingOrderingCase {
    Baseline,
    Reversed,
    Interleaved,
    OtherInterleaved,
...
type SiblingOrderCase = SamePageTrailingInputSiblingOrderingCase;

async fn run_sibling_order_case(case: SiblingOrderCase) {
    run_same_page_trailing_input_sibling_ordering_replay(case).await;
}

async fn prepare_same_page_trailing_input_sibling_ordering_fixture()
-> SamePageTrailingInputSiblingOrderingFixture {
...
fn rewrite_same_page_trailing_input_sibling_ordering(
    fixture: &SamePageTrailingInputSiblingOrderingFixture,
) {
...
async fn compile_same_page_trailing_input_sibling_ordering_second_pass(
    fixture: &SamePageTrailingInputSiblingOrderingFixture,
...
fn assert_same_page_trailing_input_sibling_ordering_replay(
    build_root: &Utf8Path,
...
async fn run_same_page_trailing_input_sibling_ordering_replay(
    case: SamePageTrailingInputSiblingOrderingCase,
) {
    let fixture = prepare_same_page_trailing_input_sibling_ordering_fixture().await;
    rewrite_same_page_trailing_input_sibling_ordering(&fixture);

    let dirty_files = match case {
        SamePageTrailingInputSiblingOrderingCase::Baseline => vec![
            Utf8PathBuf::from("refsb.bbl"),
            Utf8PathBuf::from("sections/tail.tex"),
            Utf8PathBuf::from("refsa.bbl"),
        ],
        SamePageTrailingInputSiblingOrderingCase::Reversed => vec![
            Utf8PathBuf::from("refsa.bbl"),
            Utf8PathBuf::from("sections/tail.tex"),
            Utf8PathBuf::from("refsb.bbl"),
        ],
        SamePageTrailingInputSiblingOrderingCase::Interleaved => vec![
            Utf8PathBuf::from("sections/tail.tex"),
            Utf8PathBuf::from("refsb.bbl"),
            Utf8PathBuf::from("refsa.bbl"),
        ],
        SamePageTrailingInputSiblingOrderingCase::OtherInterleaved => vec![
            Utf8PathBuf::from("sections/tail.tex"),
            Utf8PathBuf::from("refsa.bbl"),
            Utf8PathBuf::from("refsb.bbl"),
        ],
    ...
    let second =
        compile_same_page_trailing_input_sibling_ordering_second_pass(&fixture, &dirty_files).await;

    assert_same_page_trailing_input_sibling_ordering_replay(
        &fixture.build_root,
        &second,
        &dirty_files,
