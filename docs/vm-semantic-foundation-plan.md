...
text reconciles to primitive/high (`ca1f6fb`). Nested symbol/space,
unknown-command, and no-hyperlink branches still require their own bounded
regressions.
