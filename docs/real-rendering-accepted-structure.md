...
- Semantic golden normalization now covers compact event, IR, and display-list
  ...
  invocation/key spans, label definition key/invocation spans, and graphic
  invocation/path argument spans, caption and `captionof` text/invocation spans,
  and display math body/delimiter spans; more source-span edge cases should be
